...
public class OperaHandoverAdapter extends RecyclerView.Adapter {


    private Context context;
    private List<HandoverListData.ListBean> listBeans;
    double Latitude;
    double Longitude;

    public OperaHandoverAdapter(Context context) {
        this.context = context;
    }

    public void setDatas(List<HandoverListData.ListBean> listBeans) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        switch (listBeans.get(position).getS_status()) {//供应商状态 1 待受理 2 驳回 3 已受理 4 途中 5 完成
            ...
            case "3":
                ...
                viewHolder.tvCkewm.setVisibility(View.VISIBLE);
                    viewHolder.tvCf.setVisibility(View.GONE);
                    if (listBeans.get(position).getIs_takeover().equals("1")){
                ...
                viewHolder.tvSl.setVisibility(View.GONE);
                viewHolder.tvBhzt.setVisibility(View.GONE);
                viewHolder.tvYswc.setVisibility(View.GONE); viewHolder.tvYcf.setVisibility(View.GONE);
                break;
            case "4":
                viewHolder.tvXq.setVisibility(View.VISIBLE);
                viewHolder.tvCkewm.setVisibility(View.VISIBLE);
                ...
                if (listBeans.get(position).isHas_next() == false) {
                    ...
                    viewHolder.tvYswc.setVisibility(View.GONE);
                    viewHolder.tvYcf.setVisibility(View.VISIBLE);
                }
                viewHolder.tvSmjh.setVisibility(View.GONE);
                viewHolder.tvBh.setVisibility(View.GONE);
                viewHolder.tvSl.setVisibility(View.GONE);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView tvYqddsj;
        @BindView(R.id.tv_xq)
        TextView tvXq;   @BindView(R.id.tv_ycf)
        TextView tvYcf;
