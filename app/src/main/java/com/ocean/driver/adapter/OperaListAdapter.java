...
public class OperaListAdapter extends RecyclerView.Adapter {


    private Context context;
    private List<OperaListData.DataBean.ListBean> listBeans;
    double Latitude;
    double Longitude;

    public OperaListAdapter(Context context) {
        this.context = context;
    }

    public void setDatas(List<OperaListData.DataBean.ListBean> listBeans) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        switch (listBeans.get(position).getS_status()) {//供应商状态 1 待受理 2 驳回 3 已受理 4 途中 5 完成
            case "1":
                ...
                viewHolder.tvYcf.setVisibility(View.GONE);
                break;
            case "2":
                viewHolder.tvXq.setVisibility(View.VISIBLE);
            ...
            case "3":
                viewHolder.tvXq.setVisibility(View.VISIBLE);
                viewHolder.tvCkewm.setVisibility(View.VISIBLE);
                if (listBeans.get(position).isHas_prev() == true && listBeans.get(position).getIs_takeover() == 1) {
                    viewHolder.tvSmjh.setVisibility(View.VISIBLE);
                    viewHolder.tvCf.setVisibility(View.GONE);
                } else {
            ...
            case "4":
                ...
                if (listBeans.get(position).isHas_next() == false) {
                    ...
                    viewHolder.tvCf.setBackgroundResource(R.drawable.bg_red_button);
                    viewHolder.tvCf.setTextColor(context.getResources().getColor(R.color.colorRed));
    ...
    public void setScaniImp(ScaniImp scaniImp) {
        this.scaniImp = scaniImp;
    }
    //运输完成
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView tvCkewm;
        @BindView(R.id.tv_bh)
        TextView tvBh;  @BindView(R.id.tv_ycf)
        TextView tvYcf;
        @BindView(R.id.tv_sl)
        TextView tvSl;
