...
public class LoadingTypeTwoAdapter extends RecyclerView.Adapter {


    private Context context;
    List<BillData.DataBean.ListBean> listBeans;
    public LoadingTypeTwoAdapter(Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_loading_type_two, parent, false);
