...
public class BindNewPhoneActivity extends BaseActivity {
    ...
    public void onViewClicked() {
        ...
        HttpUtil.createRequest(TAG, BaseUrl.getInstence().sendSmsNew()).sendSmsNew(PreferenceUtils.getInstance().getUserToken(), etPhoneNum.getText().toString()).enqueue(new Callback<ApiResponse>() {
            @Override
